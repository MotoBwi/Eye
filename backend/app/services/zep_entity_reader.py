...
logger = get_logger('godseye.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Max retry attempts (default 3, meaning up to 3 attempts)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all edges in graph (paginated)
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If node's Labels only has "Entity", skip this entity (doesn't match our predefined types)
        - If node's Labels contains labels beyond "Entity" and "Node", keep this entity
        ...
        for node in all_nodes:
            ...
            # If predefined types specified, check if matches
        ...
        logger.info(f"Filtering complete: {total_count} total nodes, {len(filtered_entities)} qualified, "
    ...
    def get_entity_with_context(
        ...
        """
        Get single entity with full context (edges and related nodes, with retry mechanism)
