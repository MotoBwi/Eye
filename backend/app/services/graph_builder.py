...
class GraphBuilderService:
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"godseye_{uuid.uuid4().hex[:16]}"

        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="GodsEye Social Simulation Graph"
        )
    ...
    def add_text_batches(
        ...
        """Add text to graph in batches, returns all episode uuid list"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing nodes and edges, including time info, attributes and other details
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
