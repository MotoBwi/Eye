...
logger = get_logger('godseye.zep_graph_memory_updater')
...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Uses natural language description format, allowing Zep to extract entities and relationships
    ...
    def _describe_create_comment(self) -> str:
        """Post comment - includes comment content and post info"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
    ...
    def _describe_search(self) -> str:
        ...
        return f"searched for \"{query}\"" if query else "did a search"
...
class ZepGraphMemoryUpdater:
    ...
    All meaningful behaviors are updated to Zep, action_args includes complete context info:
    - Original post content for likes/dislikes
    - Original post content for reposts/quotes
    - Username for follows/mutes
    - Original comment content for likes/dislikes
    """

    # Batch send size (how many to accumulate before sending per platform)
    BATCH_SIZE = 5
    ...
    # Send interval (seconds), to avoid request too fast
    SEND_INTERVAL = 0.5
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Statistics
        self._total_activities = 0  # Number of activities actually added to queue
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains complete context info (e.g., post content, username, etc.)
