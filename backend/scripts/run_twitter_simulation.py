...
def setup_oasis_logging(log_dir: str):
    """Configure OASIS logs, use fixed-name log files"""
...
class TwitterSimulationRunner:
    ...
    def __init__(self, config_path: str, wait_for_commands: bool = True):
        ...
        Args:
            ...
            wait_for_commands: Whether to wait for commands after simulation completed（default True）
        """
    ...
    def _create_model(self):
        ...
        Unified use config from project root .env file (highest priority)：
        - LLM_API_KEY: API key
    ...
    async def run(self, max_rounds: int = None):
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(f"  Warning: cannot create initial post for Agent: {e}")
        ...
        if self.wait_for_commands:
            print("\n" + "=" * 60)
            print("Enter wait for command mode - environment keeps running")
...
async def main():
    ...
    # Initialize log config (use fixed filename, clean up old logs)
...
def setup_signal_handlers():
    ...
    Give program chance to clean up resources normally (close database, environment, etc.)
    """
