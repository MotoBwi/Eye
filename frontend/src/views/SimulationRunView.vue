  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">GODSEYE</div>
      </div>
...
const handleNextStep = () => {
  // Step3Simulation component will directly handle report generation and route jump
  // This method is only as backup
...
const startGraphRefresh = () => {
  ...
  addLog('Starting graph realtime refresh (30s)')
...
const stopGraphRefresh = () => {
  if (graphRefreshTimer) {
    ...
    addLog('Stopped graph realtime refresh')
  }
}
...
onMounted(() => {
  ...
  // Record maxRounds config (value already retrieved from query params during init)
  if (maxRounds.value) {
