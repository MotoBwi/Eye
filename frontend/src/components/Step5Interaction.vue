        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat version of the report generation agent, can call 4 professional tools, with full God's Eye memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with simulation environment state, combined with Global/Local Memory mechanism, provide cross-temporal deep attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Based on graph structure breadth-first traversal algorithm, reconstruct event propagation paths, capture topological structure of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized index efficiency, used for quickly extracting specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview, can conduct multi-round dialogue with individuals in the simulation world in parallel, collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to understand report in depth' : 'Chat with simulated individuals to understand their views' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter question you want to ask all selected individuals..."
                rows="3"
              ></textarea>
            </div>
...
const selectReportAgentChat = () => {
  ...
  // Restore Report Agent's chat record
...
const selectAgent = (agent, idx) => {
  ...
  // Restore that Agent's chat record
...
const renderMarkdown = (content) => {
  ...
  // Fix non-consecutive ordered list numbering: keep numbering incrementing when single <ol> is separated by paragraph content
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Auto-save chat record to cache
    saveChatHistory()
  }
}
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .join('\n')
    prompt = `Below is our previous conversation: \n${historyContext}\n\nMy new question is: ${message}`
  }
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prefer getting reddit platform response
...
/* Fix ordered list numbering - use CSS counter to make multiple ol numbering consecutive */
.message-text {
